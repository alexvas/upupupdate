...
var DateTimeShortcuts = {
    ...
    handleCalendarCallback: function(num) {
        return "function(y, m, d) { var dt = new Date(); dt.setFullYear(y); dt.setMonth(m-1); dt.setDate(d); DateTimeShortcuts.calendarInputs["+num+"].value = dt.format('l, F d, Y'); document.getElementById(DateTimeShortcuts.calendarDivName1+"+num+").style.display='none';}";
    },
    handleCalendarQuickLink: function(num, offset) {
       var d = new Date();
       d.setDate(d.getDate() + offset)
       DateTimeShortcuts.calendarInputs[num].value = d.format('l, F d, Y');
